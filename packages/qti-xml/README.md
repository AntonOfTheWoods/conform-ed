...
- it works against user-provided paths such as `tmp/qti-examples`
...
- `bun run qti:inventory:examples -- --root tmp/qti-examples`
...
- `bun run qti:coverage:report -- --root tmp/qti-examples`
