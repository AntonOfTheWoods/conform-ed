...
export type OpenVideoContributorRole = z.infer<typeof OpenVideoContributorRoleSchema>;
export type OpenVideoRecordingAgentType = z.infer<typeof OpenVideoRecordingAgentTypeSchema>;
export type OpenVideoOperatingSystem = z.infer<typeof OpenVideoOperatingSystemSchema>;
export type OpenVideoRenditionType = z.infer<typeof OpenVideoRenditionTypeSchema>;
export type OpenVideoStreamSource = z.infer<typeof OpenVideoStreamSourceSchema>;
export type OpenVideoAttachment = z.infer<typeof OpenVideoAttachmentSchema>;
export type OpenVideoCaptions = z.infer<typeof OpenVideoCaptionsSchema>;
export type OpenVideoCaptureManifest = z.infer<typeof OpenVideoCaptureManifestSchema>;
export type OpenVideoSocialMedia = z.infer<typeof OpenVideoSocialMediaSchema>;
export type OpenVideoContactInfo = z.infer<typeof OpenVideoContactInfoSchema>;
export type OpenVideoName = z.infer<typeof OpenVideoNameSchema>;
export type OpenVideoContributor = z.infer<typeof OpenVideoContributorSchema>;
export type OpenVideoContributors = z.infer<typeof OpenVideoContributorsSchema>;
export type OpenVideoCut = z.infer<typeof OpenVideoCutSchema>;
export type OpenVideoCuts = z.infer<typeof OpenVideoCutsSchema>;
export type OpenVideoLayout = z.infer<typeof OpenVideoLayoutSchema>;
export type OpenVideoLocation = z.infer<typeof OpenVideoLocationSchema>;
export type OpenVideoMarkerBase = z.infer<typeof OpenVideoMarkerBaseSchema>;
export type OpenVideoDeckMarker = z.infer<typeof OpenVideoDeckMarkerSchema>;
export type OpenVideoFileMarker = z.infer<typeof OpenVideoFileMarkerSchema>;
export type OpenVideoHighlightMarker = z.infer<typeof OpenVideoHighlightMarkerSchema>;
export type OpenVideoMarker = z.infer<typeof OpenVideoMarkerSchema>;
export type OpenVideoSpeakerMarker = z.infer<typeof OpenVideoSpeakerMarkerSchema>;
export type OpenVideoRelatedVideoMarker = z.infer<typeof OpenVideoRelatedVideoMarkerSchema>;
export type OpenVideoMarkers = z.infer<typeof OpenVideoMarkersSchema>;
export type OpenVideoRecordingAgent = z.infer<typeof OpenVideoRecordingAgentSchema>;
export type OpenVideoRecordingAgents = z.infer<typeof OpenVideoRecordingAgentsSchema>;
export type OpenVideoRendition = z.infer<typeof OpenVideoRenditionSchema>;
export type OpenVideoStream = z.infer<typeof OpenVideoStreamSchema>;
export type OpenVideoStreams = z.infer<typeof OpenVideoStreamsSchema>;
export type OpenVideoTag = z.infer<typeof OpenVideoTagSchema>;
export type OpenVideoTags = z.infer<typeof OpenVideoTagsSchema>;
export type OpenVideoThumbnailTime = z.infer<typeof OpenVideoThumbnailTimeSchema>;
export type OpenVideoSession = z.infer<typeof OpenVideoSessionSchema>;
export type OpenVideoSessionDocument = z.infer<typeof OpenVideoSessionDocumentSchema>;
