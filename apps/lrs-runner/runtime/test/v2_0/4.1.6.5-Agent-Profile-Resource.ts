...
type AgentProfileHelper = {
  ...
  getUrlEncoding(object: AgentProfileParams | Record<string, string>): string;
...
type AgentProfileRequests = {
  ...
  deleteDocument(path: string, params: AgentProfileParams): Promise<XapiHttpResponse>;
  getDocuments(path: string, params: AgentProfileParams): Promise<XapiHttpResponse>;
  postDocument(path: string, body: DocumentPayload, params: AgentProfileParams): Promise<XapiHttpResponse>;
};
